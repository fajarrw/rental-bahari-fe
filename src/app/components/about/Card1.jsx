                      ...
                      <div className="py-4">
                        ...
                        <div className="h-48 px-6 overflow-y-scroll ">
                          <p className="block mb-8 text-base md:text-lg font-normal leading-relaxed text-black">
                            Kepercayaan adalah pijakan utama kami di dunia
                            layanan rental mobil. Kami memahami bahwa
                            mempercayakan kendaraan Anda kepada kami merupakan
                            tanggung jawab besar, dan itulah mengapa kami
                            mengutamakan integritas dan keandalan dalam setiap
                            aspek layanan kami. Pelanggan kami tidak hanya
                            menyewa mobil, tetapi mereka juga mempercayakan
                            pengalaman perjalanan mereka kepada kami, dan itulah
                            yang menjadi fokus utama kami.
                          </p>

                          <p className="block mb-2 text-base md:text-lg font-normal leading-relaxed text-black">
                            Dalam menciptakan rasa percaya, kami mengambil
                            langkah-langkah konkret untuk memastikan keamanan
                            dan kenyamanan pelanggan. Flotak mobil kami secara
                            berkala menjalani pemeriksaan menyeluruh, memastikan
                            bahwa setiap kendaraan dalam kondisi optimal sebelum
                            diserahkan kepada pelanggan. Kami juga mengusung
                            prinsip transparansi penuh dalam hal harga dan
                            ketentuan layanan, sehingga pelanggan tidak hanya
                            mendapatkan kendaraan yang andal, tetapi juga
                            pemahaman yang jelas tentang apa yang mereka bayar.
                            Dengan reputasi yang terjaga dan dukungan pelanggan
                            24/7, kami bertekad membangun hubungan yang kokoh
                            dengan pelanggan kami, menjadikan kepercayaan
                            sebagai dasar utama dalam setiap perjalanan yang
                            mereka tempuh bersama kami.
                          </p>
                        </div>
                      </div>
                    </div>
