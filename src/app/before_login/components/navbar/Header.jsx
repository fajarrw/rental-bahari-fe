...
export default function Header() {
  ...
  return (
        <header id="navbar" className="bg-dark-green-1 shadow-md py-5 w-full max-w-[1920px] mx-auto z-20 transition-all duation-300">
            ...
            <div className="container mx-auto flex flex-col xl:flex-row xl:items-center xl:justify-between">
                <div className="flex justify-between items-center px-4">
                    ...
                    <div className="xl:hidden flex flex-row justify-center gap-4">
                        <div className="flex flex-row items-center gap-4 ">
                            <div class="border-2 bg-transparent rounded-xl px-3 py-1 cursor-pointer hover:bg-dark-green-2">
                                <a 
                ...
                <div className="flex flex-row items-center gap-4 hidden xl:flex px-4">
                    <div class="border-2 bg-transparent rounded-xl px-3 py-1 cursor-pointer hover:bg-dark-green-2">
                        <a 
                        className="cursor-pointer mx-auto text-[#E4E4E4] hover:text-gray-200" 
                        href="/login"
                    ...
                    <div class="hidden md:block border-2 bg-white text-black rounded-xl px-3 py-1 cursor-pointer hover:bg-dark-green-2">
                        <a 
