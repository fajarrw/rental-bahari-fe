                      ...
                      <div class="py-4">
                        ...
                        <div className="h-48 px-6 overflow-y-scroll ">
                          <p className="block mb-8 text-base md:text-lg antialiased font-normal leading-relaxed text-black">
                            ...
                            cepat dan mudah memilih kendaraan yang sesuai dengan kebutuhan mereka, mengatur tanggal dan lokasi 
                            pengambilan, serta menyelesaikan pembayaran dengan transparan. Kami percaya bahwa kesederhanaan adalah 
                            kunci untuk memberikan pengalaman pemesanan yang memuaskan, membebaskan pelanggan dari kerumitan 
                          ...
                          <p className="block mb-2 text-base md:text-lg antialiased font-normal leading-relaxed text-black">
                            ...
                            berukuran kecil yang cocok untuk perjalanan solo hingga SUV mewah untuk perjalanan keluarga, kami 
                            menawarkan pilihan kendaraan yang memenuhi berbagai kebutuhan. Kombinasi antara kemudahan pemesanan dan 
                            keunggulan kendaraan menjadikan kami pilihan utama bagi mereka yang menginginkan perjalanan tanpa 
                            kesulitan dengan kendaraan yang luar biasa.
                          </p>
                        </div>
                      </div>
                    </div>
