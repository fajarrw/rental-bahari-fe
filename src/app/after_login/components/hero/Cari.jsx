...
export default function Cari() {
  ...
  return (
    <div className=" py-6 max-w-[1170px] mx-auto flex flex-col xl:flex-row justify-center xl:justify-start gap-4  relative  lg:shadow-1 bg-white lg:bg-transparent rounded-lg"
    >
